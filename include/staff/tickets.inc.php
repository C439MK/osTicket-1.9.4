         ...
         if($thisstaff->canManageTickets()) { ?>
           <p class="centered" id="actions">
            ...
            switch (strtolower($status)) {
                case 'closed': ?>
					<!-- This provides Reopen button at button of closed ticket list -->
                ...
                case 'assigned':
					...
					<!-- This provides closed button at bottom of "My Tickets" list -->
                    <!-- <input class="button" type="submit" name="close" value="Close"> -->
                    <?php
                    break;
                case 'overdue':
                    ?>
					<!-- This provides closed button at bottom of Review list -->
                    <!-- <input class="button" type="submit" name="close" value="Close"> -->
                    <?php
                    break;
                default: //search??
                    ?>
					<!-- These provide close and reopen buttons at bottom of any other page -->
                    <!-- <input class="button" type="submit" name="close" value="Close" > -->
                    <!-- <input class="button" type="submit" name="reopen" value="Reopen"> -->
            <?php
            }
