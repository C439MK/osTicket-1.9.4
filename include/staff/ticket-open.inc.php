...
if($_POST && !$info["deptId"])
	$errors["deptId"] = "Department required";
	
if($_POST && !$info["assignId"])
	$errors["assignId"] = "Assignee required";
 ...
 <table class="form_table fixed" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <input type="checkbox" name="alertuser" <?php echo ($info['alertuser'])? 'checked="checked"': ''; ?>>Send alert to user.
            </td>
        </tr>
        <?php
        } ?>
        ...
        <tr>
            ...
            <td>
                <select name="source">
                    ...
                    <option value="Person" <?php echo ($info['source']=='Person')?'selected="selected"':''; ?>>In Person</option>
                    <option value="Online" <?php echo ($info['source']=='Online')?'selected="selected"':''; ?>>Online</option>
                    <option value="Letter" <?php echo ($info['source']=='Letter')?'selected="selected"':''; ?>>Letter</option>
                </select>
...
<?php                   }
        ...
        <tr>
            <td width="160" class="required" >Assign To:</td>
            <td>
